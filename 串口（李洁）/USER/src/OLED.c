...
#define LCD_RST_1  GPIO_SetBits(GPIOB,GPIO_Pin_12)
#define LCD_RST_0  GPIO_ResetBits(GPIOB,GPIO_Pin_12)

#define LCD_DC_1   GPIO_SetBits(GPIOB,GPIO_Pin_13)
#define LCD_DC_0   GPIO_ResetBits(GPIOB,GPIO_Pin_13)

#define LCD_SCL_1  GPIO_SetBits(GPIOB,GPIO_Pin_14)
#define LCD_SCL_0  GPIO_ResetBits(GPIOB,GPIO_Pin_14)

#define LCD_SDA_1  GPIO_SetBits(GPIOB,GPIO_Pin_15)
#define LCD_SDA_0  GPIO_ResetBits(GPIOB,GPIO_Pin_15)
